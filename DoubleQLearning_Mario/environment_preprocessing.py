...
# M: Transform image/ observation from rgb to grayscale [3, 240, 256] -> [1, 240, 256]
...
# M: Downsample each image/ observation into square size [1, 240, 256] -> [1, 84, 84]
